...
from models import note_preprocess, pre_model
from music import MusicTunerEnv, NUM_CLASSES, NOTES_PER_BAR
from rl import Memory

time_steps = 8
ENV_NAME = 'music-tune-v0'  # Environment name
INPUT_SIZE = NUM_CLASSES  # Resized frame widt = 84
NUM_EPISODES = 12000  # Number of episodes the agent plays
STATE_LENGTH = 4  # Number of most recent frames to produce the input to the network
GAMMA = 0.99  # Discount factor
# Number of steps over which the initial value of epsilon is linearly
